...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [2891215.207880, 5532952.483667, 2913961.925085, 5550465.338848], maxZoom: 27, minZoom: 1
    })
});
...
map.getView().fit([2891215.207880, 5532952.483667, 2913961.925085, 5550465.338848], map.getSize());
